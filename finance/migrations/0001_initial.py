# Generated by Django 4.0.4 on 2022-06-25 12:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expense_item', models.ForeignKey(default='-1', on_delete=django.db.models.deletion.SET_DEFAULT, to='finance.expenseitem', verbose_name='費目')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='投稿者')),
            ],
        ),
    ]
